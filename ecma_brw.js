...
var ES51  = Modernizr.es5,
    ...
    */
    ...
    if(ES7) {
        console.log('Tu navegador contiene caracteristicas minimas ECMAScript 7');
    }else if (ES6){
        ...
        console.log('Tu navegador contiene caracteristicas de ECMAScript 1');
    }else{
        console.log('Tu navegador contiene caracteristicas de ECMAScript desconocidas');
    }
